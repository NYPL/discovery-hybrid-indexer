...
const buildDiscoveryStoreBibs = async (bibs) => {
  ...
  // Parse ENABLE_TIMETWISTER, default to false
  const enableTimeTwister = process.env.ENABLE_TIMETWISTER === 'true'
  await parseDatesAndCache(bibsPlusItemsAndRecapCodes, enableTimeTwister)
